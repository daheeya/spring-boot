...
public class LoggingAop {
    ...
    public void afterReturn(JoinPoint joinPoint, Object returnObj, UserInfoDto userInfoDto){
        if(returnObj instanceof ResponseEntity) {  // RsponseEntity 인 이유!
            String status = ((ResponseEntity) returnObj).getStatusCode().toString();
            var dto2 = userInfoDto;
            dto2.setEmail(Base64.getEncoder().encodeToString(dto2.getEmail().getBytes()));
